...
import com.harana.sdk.models.plugin.PageImporter.PageImporterId

case class PageImporter(title: String,
                        description: String,
...
object PageImporter {
	...
	def apply(title: String, description: String, parameterValues: Map[ParameterId, String], createdBy: User): PageImporter = {
