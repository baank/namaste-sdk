package com.naden.namaste.ui.components.maps

import com.naden.namaste.ui.components.maps.GoogleMap.MapPosition.MapPosition
import com.naden.namaste.ui.components.maps.GoogleMap.MapType.MapType
...
object GoogleMap {
  ...
  def apply(name: String,
            ...
            markers: List[Marker] = List()): Binding[Div] = {
    <div></div>
  }
